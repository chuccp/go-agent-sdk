...
func (s *Service) ChatWithStream(ctx context.Context, chatMessages *chat.Messages, response chat.BlockWriter) error {
...
func (s *Service) parseSSE(ctx context.Context, body io.ReadCloser, resp chat.BlockWriter) error {
	defer body.Close()
