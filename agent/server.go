...
func (m *Server) GetOrCreateSession(sessionId string, options ...Option) *Session {
	m.lock.Lock()
	defer m.lock.Unlock()
...
func (m *Server) GetSession(sessionId string) (*Session, bool) {
	m.lock.Lock()
	defer m.lock.Unlock()
...
func (m *Server) SessionContext(sessionId string) *SessionContext {
	m.lock.Lock()
...
func (m *Server) RemoveSession(sessionsId string) {
	m.lock.Lock()
	defer m.lock.Unlock()
