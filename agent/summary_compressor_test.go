...
func (f *fakeContext) SubAgentStore() *Store                       { return nil }
func (f *fakeContext) AgentStore() *Store                          { return nil }
func (f *fakeContext) SendBlock(uint64, chat.Block) uint64         { return 0 }
func (f *fakeContext) SendSignalBlock(uint64, chat.Block) uint64   { return 0 }
func (f *fakeContext) GetTransferStart() uint64                    { return 0 }
func (f *fakeContext) AppendMainAssistantMessage(*chat.BlockGroup) {}
func (f *fakeContext) AppendMainUserMessage(*chat.BlockGroup)      {}
